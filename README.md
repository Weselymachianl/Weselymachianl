...
- 利用純 **Python** 獨立開發之通訊系統 AI 優化演算法
- 針對多用戶流體天線，結合 **RZF 預編碼** 與改良版強化學習 (Assisted D3QN)，在僅具部分埠口資訊下最大化系統總和速率
- 導入卷積條件神經過程 **(ConvCNP)** 與漸進式學習解決傳統 DRL 收斂瓶頸
- 採 3 組隨機種子嚴謹驗證，確保模型具備高度統計可信度
...
- 從演算法開發到網頁全端實作的整合性專案
- 使用 **Python** 核心技術優化惡劣環境下的 QR Code 辨識率
- 透過 **Node.js** 與 **HTML/CSS/JS** 建立互動式展示平台
- 憑藉高實用性與跨技術整合的完整度，**榮獲畢業專題佳作**
...
- 使用 **Node.js** 與 **Express** 框架開發後端，打造多人即時互動聊天室
